...
void ReadFile(){
    ...
    string PathFile = "/home/gate/Desktop/260220/cuivre64/output/";
    string NameFile = "Spectrum.root";
...
//     string PathFile = "/media/sf_PartageVbox8/";
    string NameFile2 = "Pos_spectra.root";
 ...
 // string NameFile3 = "Spectre_gamma1.root";
  // TString Complete_PathFile3 = PathFile+NameFile3;
    
 // TFile *fileData3 = new TFile(Complete_PathFile3);
 // TH1F * h3 = (TH1F*)fileData3->Get("energySpectrumNbPart");     

   TString NameCanvas = "Comparaison";
   TCanvas * C_temp = NULL;
...
// 	       hSimu->SetTitle(Title);
 ...
 h1->SetTitle("Spectre en energie du 64Cu");
  h1->GetYaxis()->SetTitle("Probabilite normalisee");
  h1->GetXaxis()->SetRangeUser(0,0.7);
    h1->SetLineColor(2);
    h2->SetLineColor(1);
    
  //  C_temp* legend = new TLegend(0.2, 0.2, .8, .8);
   // legend->AddEntry(h1,"Beta");
   // legend->AddEntry(h2,"Positron");
